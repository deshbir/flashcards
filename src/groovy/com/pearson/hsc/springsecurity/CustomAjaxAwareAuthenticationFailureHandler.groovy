 ...
 */
package com.pearson.hsc.springsecurity;
 ...
 */
public class CustomAjaxAwareAuthenticationFailureHandler extends ExceptionMappingAuthenticationFailureHandler implements InitializingBean {
	...
	public void onAuthenticationFailure(final HttpServletRequest request, final HttpServletResponse response,
		...
		if (SpringSecurityUtils.isAjax(request)) {
			...
			if (_useForward) {
				request.getRequestDispatcher(_ajaxAuthenticationFailureUrl).forward(request, response);
			} else {
	...
	public void afterPropertiesSet() {
		...
		Assert.notNull(_useForward, "useForward is required");
	}
}
